...
cli
  ...
  .action(async (appName, options) => {
    console.log(chalk.emerald ? chalk.emerald(`\n⚽ SportFi Kit: Creating "${appName}"...`) : chalk.green(`\n⚽ SportFi Kit: Creating "${appName}"...`));
...
cli
  ...
  .action(async () => {
    console.log(chalk.emerald ? chalk.emerald(`\n🛠️ SportFi Kit: Initializing in current directory...`) : chalk.green(`\n🛠️ SportFi Kit: Initializing in current directory...`));
    await initCommand();
  });
...
cli
  ...
  .action(async (name) => {
    console.log(chalk.emerald ? chalk.emerald(`\n💡 SportFi Kit: Adding example "${name}"...`) : chalk.green(`\n💡 SportFi Kit: Adding example "${name}"...`));
